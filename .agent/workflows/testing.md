...
1. **Run Automated Tests**:
   - Run `pnpm prepare` to install browser dependencies.
   - Run `pnpm test` to execute the Cucumber/Playwright tests.

2. **Open the Assessment Manually (Optional)**:
   - Run `pnpm start` to run the application
   - Navigate to <http://127.0.0.1:8080>

3. **Direct Results Testing**:
